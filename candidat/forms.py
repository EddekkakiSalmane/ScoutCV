...
class CandidatForm(forms.ModelForm):
    ...
    # dob         =forms.DateField(label = 'Date de naissance')
    # #sex         = forms.CharField(max_length=1,choices=SEX,blank=False,default="")
    # status      = forms.CharField(mgitax_length=10,widget=forms.TextInput(attrs={"placeholder": "célibataire ,marié(e) ,veuf(ve) ,divorcé(e)"}))
